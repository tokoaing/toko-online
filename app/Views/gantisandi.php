...
<body style="width:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;padding:0;Margin:0">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:20px;Margin:0">
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:72px;color:#4de9d1;font-size:48px"><strong>GRAVER FURNITURE</strong></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
    ...
    <script>
        $(document).ready(function() {
            // proses ubah sandi
            $('.formubahsandi').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.error) {
                            ...
                            if (err.errUserUlangPassword) {
                                $('#ulangpassword').addClass('is-invalid');
                                $('.errorUserUlangPassword').html(err.errUserUlangPassword);
                            } else {
                                $('#ulangpassword').removeClass('is-invalid');
                                $('#ulangpassword').addClass('is-valid');
                            }
                        }
